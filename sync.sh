...
rsync -rtvPa ./Library/Application\ Support2/BetterTouchTool ~/Library/Application\ Support/
...
rsync -rtvPa ./Library/Application\ Support/Source\ Tree ~/Library/Application\ Support/
